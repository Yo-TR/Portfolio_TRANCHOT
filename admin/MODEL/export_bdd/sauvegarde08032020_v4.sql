...
--
-- Host: localhost    Database: tranchot_portfolio
-- ------------------------------------------------------
...
INSERT INTO `categorie_menu` VALUES (1,'Accueil'),(2,'À propos'),(3,'Compétences'),(4,'Projets'),(5,'Contact');
...
INSERT INTO `contact_form` VALUES (1,'','','','2020-03-06','');
...
CREATE TABLE `item_menu` (
  `Id_sous-categorie` int(11) NOT NULL AUTO_INCREMENT,
  `Nom` varchar(255) NOT NULL,
...
INSERT INTO `item_menu` VALUES (1,'AUDIOVISUEL',4),(2,'PROGRAMATION',4),(3,'MULTIMÉDIA',4);
...
CREATE TABLE `media` (
  ...
  `Chemin` text COLLATE utf8_roman_ci NOT NULL,
  `ID_Page` int(11) NOT NULL,
  `Lien` text COLLATE utf8_roman_ci NOT NULL,
  `Titre` varchar(255) COLLATE utf8_roman_ci NOT NULL,
  PRIMARY KEY (`ID_Media`)
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COLLATE=utf8_roman_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `media` VALUES (1,'img','/visiteur/VUE/image/carrousel.jpg',7,'','carrousel'),(2,'img','/visiteur/VUE/image/film_metier.png',6,'','film_metier'),(3,'img','/visiteur/VUE/image/flag-for-guadeloupe_1f1ec-1f1f5.png',0,'','flag'),(4,'img','/visiteur/VUE/image/souris.jpg',7,'','souris'),(5,'img','/visiteur/VUE/image/teammeca.jpg',7,'','teammeca'),(6,'img','/visiteur/VUE/image/tower defense.jpg',7,'','tower'),(7,'img','/visiteur/VUE/image/y.png',0,'','y'),(8,'img','/visiteur/VUE/image/yoann.png',0,'','yoann'),(9,'youtube','http://www.youtube.com/embed/6X4rqUCNH3o?autoplay=1&rel=0&showinfo=0',5,'6X4rqUCNH3o','Le chef de projet - ITW'),(10,'youtube','http://www.youtube.com/embed/UuLsSFWqLc4?autoplay=1&rel=0&showinfo=0',5,'UuLsSFWqLc4','CDP - Motion');
...
-- Dump completed on 2020-03-08 19:37:40
